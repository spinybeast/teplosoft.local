...
function savevideo(){
	...
	$.ajax({
		url: "" + url + "?fc=module&module=bavideotab&controller=savevideo",
		type: "POST",
		data: formData,
		async: false,
...
function Edit(id_product){
    ...
    $.post("" + url + "?fc=module&module=bavideotab&controller=editvideo",
        {
            id: id_product
        },
...
function ConfirmDelete(id_product,type,id_lang)
{
  ...
  if (x == true) {
	$.post(url + "?fc=module&module=bavideotab&controller=confirmdelete",
		{
			id: id_product,
			id_lang: id_lang,
			id_shop: id_shop_new,
